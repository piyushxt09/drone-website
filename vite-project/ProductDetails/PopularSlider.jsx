...
import "../components/css/popular-slider.css";
...
export default function Popularslider() {
    return (
        <section className=" my-0 mt-0 mt-md-5">
            <div className="container">
                <div className="row Tranding-rows  mb-5 mt-3">
                    <div className="col-lg-12">
                        <h3 className="fs-2 my-primary-text mb-0 ">Similar Drones</h3>
                        <Swiper
                                    ...
                                    >
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div className="text-center mt-5">
                                                <button className="btn btn-info text-white rounded-circle" onClick={() => window.location.href = "product-detail"}>
